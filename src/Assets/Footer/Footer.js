  ...
  return (
    <div className="bg-topbar font-barlow">
      <div className="row linha-footer p-3 m-auto">
        <div className="col">
          <div className="c-white fw-500 f-1-2">Thamires Morais de Sousa</div>
        ...
        <div className="col">
          ...
          <div className="c-gray-claro d-grid mt-2">
            <a
              ...
              href="https://www.linkedin.com/in/thamires-morais-3b1053187/"
              target="_blank"
            >
              Linkedin
            </a>
            <a
              className="c-gray-claro o-none w-fit"
              href="https://www.instagram.com/thamsjobs/"
              target="_blank"
            >
              Instagram
            </a>
